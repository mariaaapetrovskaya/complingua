...
External data?
Использовались только данные из датасета mapetrovska/gesturedataset.
...
Основная сложность проекта это техническая адаптация: преобразование видео в кадры, работа с разными форматами (VideoDecoder и bytes), ограничения памяти в Colab.
...
A9. Model Execution Time
Training time (full model)	zero-shot inference
...
Датасет жестов: mapetrovska/gesturedataset
